...
3. What is closure?
closure is an inner function that can access the enclosing functions variables -- as well as its parent, global and own variables.
...
super() allows us to access and call functions on an objects parent.
